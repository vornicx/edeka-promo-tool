...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-4JTXQXMQ.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-4JTXQXMQ.js")).default(client, args);
    case "add":
      return (await import("./add-PVEKZBHH.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-HC745CYT.js")).default(client, args);
    case "rm":
      return (await import("./rm-XA4LYZXI.js")).default(client, args);
    case "update":
      return (await import("./update-PU3WLIA7.js")).default(client, args);
    default:
