        ...
        {directions.map((dir, i) => (
          <button
            ...
            className={`relative p-5 rounded-2xl border-2 text-left transition-all duration-300 ${
              selectedIndex === i
                ? "border-edeka-blue bg-edeka-lightblue shadow-elevated scale-[1.02]"
                : "border-gray-200 bg-white hover:border-edeka-blue/40 hover:shadow-card-hover hover:-translate-y-0.5"
            }`}
          >
            {selectedIndex === i && (
            ...
            <div className="mt-3 flex flex-wrap gap-1.5">
              ...
              {dir.waschbaer_presence !== "none" && (
                <span className="badge bg-edeka-yellow/20 text-edeka-darkblue">
